...
// uji jika klik tombol edit atau hapus 
    if(isset($_GET['hal'])){
        ...
        $tampil = mysqli_query($koneksi, "SELECT 
                        ...
                        AND 
                            tbl_arsip.id_pengirim = tbl_pengirim_surat.id_pengirim 
        ...
        elseif ($_GET['hal'] == 'hapus') {
            $hapus = mysqli_query($koneksi, "DELETE FROM tbl_arsip WHERE
            id_arsip='$_GET[id]'");
            if($hapus){
                echo "<script>
    ...
    if(isset($_POST['bsimpan'])){
        ...
        if(@$_GET['hal'] == "edit"){
            ...
            //cek apakah user pilh gamabar/file
    ...
    <div class="card-body">
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" name="file" class="form-control" id="file" value="<?=@$vfile?>">
            </div>
